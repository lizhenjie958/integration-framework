...
public class HdfsClient {
    ...
    public void testPut() throws IOException {
        ...
        fs.copyFromLocalFile(false, true, new Path("C:\\tmp\\hadoop-study-file"), new Path("hdfs://hadoop102/xiyou/huaguoshan"));
    }
    ...
    public void testGet() throws IOException {
        ...
        fs.copyToLocalFile(false, new Path("hdfs://hadoop102/a.txt"), new Path("C:\\tmp\\hadoop-study-file"), false);
    }
    ...
    public void testmv() throws IOException {
        ...
        // 目录更名
        fs.rename(new Path("/input1"), new Path("/input222"));
